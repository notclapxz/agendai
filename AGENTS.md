...
│       └── voice/route.ts      # POST — gpt-4o-transcribe + gpt-4o-mini (json_schema) → tareas estructuradas
├── components/
...
2. gpt-4o-mini (`temperature: 0`, `json_schema`) → extrae array de tareas estructuradas
